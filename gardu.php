...
$hasil = mysqli_query($conn, "SELECT * FROM akun WHERE username='$_SESSION[username]'");
                ...
                <div class="row mt-2">
                    <div class="card-body ms-4 mt-4">
                        <div class="data_table">
                            <a href="proses/proses_cetak_excel.php" class="btn btn-success" target="_blank">Excel</a>
                                            ...
                                            <td>
                                                ...
                                                <div class="modal fade" id="setujui<?php echo $no ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <form method="POST" action="proses/proses_setujui_opgardu.php">
                                                                <input type="hidden" name="kode_gardu" value="<?php echo $data['kode_gardu'] ?>">
                                                                <div class="modal-body">
                                                                    <div class="mb-3">
                                                                        <label for="recipient-name" class="form-label">Kode Gardu</label>
                                                                        <input type="text" class="form-control" name="kode_gardu" value="<?php echo $data['kode_gardu'] ?>" readonly>
                                                                    </div>
                                                                    <div class="mb-3">
                                                ...
                                                <div class="modal fade" id="exampleModaledit<?php echo $no ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form method="POST" action="proses/proses_edit_gardu.php">
                                                                    <input type="hidden" name="kode_gardu" value="<?php echo $data['kode_gardu'] ?>">
                                                                    <div class="mb-3">
                                                                        <label for="recipient-name" class="form-label">Kode Gardu</label>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label for="recipient-name" class="form-label">Tipe Gardu</label>
                                                                        <input type="text" class="form-control" name="type_gardu" value="<?php echo $data['type_gardu'] ?>">
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label for="recipient-name" class="form-label">Jenis Pelayanan</label>
                                                                        <input type="text" class="form-control" name="jenis_pelayanan" value="<?php echo $data['jenis_pelayanan'] ?>">
                                                                    </div>
                                                                    <div class="mb-3">
                                                ...
                                                <div class="modal fade" id="exampleModaldelete<?php echo $no ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h1 class="modal-title fs-5" id="exampleModalLabel">Hapus Data Gardu</h1>
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                                            <div class="modal-body">
                                                                <form method="POST" action="proses/proses_delete_gardu.php">
                                                                    <input type="hidden" name="kode_gardu" value="<?php echo $data['kode_gardu'] ?>">
                                                                    <div class="modal-body">
                                                                        Yakin ingin menghapus <?php echo $data['kode_gardu']; ?> ?
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                                                ...
                                                <!-- End Modal Delete -->
                                                <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModaldetail">
                                                ...
                                                <div class="modal fade" id="exampleModaldetail" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-xl">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h1 class="modal-title fs-5" id="exampleModalLabel">Detail Data Gardu</h1>
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                                            <div class="modal-body">
