...
$sql = mysqli_query($conn, "SELECT * FROM tiang");
?>
<!doctype html>
<html lang="en">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $data['kode_tiang'] . "<br>"; ?></td>
                                            ...
                                            <td><?php echo $data['feature'] . "<br>"; ?></td>
                                            <td>
                                                ...
                                                <div class="modal fade" id="setujui<?php echo $no ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <form method="POST" action="proses/proses_setujui_optiang.php">
                                                                <input type="hidden" name="kode_tiang" value="<?php echo $data['kode_tiang'] ?>">
                                                                <div class="modal-body">
                                                                    <div class="mb-3">
                                                                        <label for="recipient-name" class="form-label">Kode Tiang</label>
                                                                        <input type="text" class="form-control" name="kode_tiang" value="<?php echo $data['kode_tiang'] ?>" readonly>
                                                                    </div>
                                                                    <div class="mb-3">
                                                ...
                                                <!-- Akhir Modal Setujui -->
                                                <button data-bs-toggle="modal" data-bs-target="#exampleModaledit<?php echo $no ?>" type="button" class="btn btn-warning">
                                                ...
                                                <div class="modal fade" id="exampleModaledit<?php echo $no ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h1 class="modal-title fs-5" id="exampleModalLabel">Edit Data Tiang</h1>
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                                            <div class="modal-body">
                                                                <form method="POST" action="proses/proses_edit_tiang.php">
                                                                    <input type="hidden" name="kode_tiang" value="<?php echo $data['kode_tiang'] ?>">
                                                                    <div class="mb-3">
                                                                        <label for="recipient-name" class="form-label">Kode Tiang</label>
                                                                        <input type="text" class="form-control" name="kode_tiang" value="<?php echo $data['kode_tiang'] ?>">
                                                                    </div>
                                                                    <div class="mb-3">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label for="recipient-name" class="form-label">Jenis</label>
                                                                        <input type="text" class="form-control" name="jenis_tiang" value="<?php echo $data['jenis_tiang'] ?>">
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label for="recipient-name" class="form-label">Ukuran</label>
                                                                        <input type="text" class="form-control" name="ukuran_tiang" value="<?php echo $data['ukuran_tiang'] ?>">
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label for="recipient-name" class="form-label">Feature</label>
                                                                        <input type="text" class="form-control" name="feature" value="<?php echo $data['feature'] ?>">
                                                                    </div>
                                                                    <div class="mb-3">
                                                ...
                                                <div class="modal fade" id="exampleModaldelete<?php echo $no ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h1 class="modal-title fs-5" id="exampleModalLabel">Hapus Data Tiang</h1>
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                                            <div class="modal-body">
                                                                <form method="POST" action="proses/proses_delete_tiang.php">
                                                                    <input type="hidden" name="kode_tiang" value="<?php echo $data['kode_tiang'] ?>">
                                                                    <div class="modal-body">
                                                                        Yakin ingin menghapus <?php echo $data['kode_tiang']; ?> ?
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
